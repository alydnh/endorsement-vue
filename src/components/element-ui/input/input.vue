<template>
    ...
    'el-input-group': $slots.prepend || $slots.append || messageMode,
    'el-input-group--append': $slots.append,
    'el-input-group--prepend': $slots.prepend,
    'el-input--prefix': $slots.prefix || prefixIcon,
    'el-input--suffix': $slots.suffix || suffixIcon || clearable,
    'pt-input-message': messageMode,
}
        ...
        <template v-if="type !== 'textarea'">
            ...
            <input :tabindex="tabindex" v-if="type !== 'textarea'" class="el-input__inner" v-bind="$attrs" :type="type" :disabled="inputDisabled" :readonly="readonly" :autocomplete="autoComplete || autocomplete" :value="currentValue" ref="input" @compositionstart="handleComposition" @compositionupdate="handleComposition" @compositionend="handleComposition" @input="handleInput" @focus="handleFocus" @blur="handleBlur" @change="handleChange" :aria-label="label" :style="inputStyles">
            <!-- 前置内容 -->
            ...
            <!-- EDIT -->
            <div class="pt-input-message__append" v-if="messageMode">
                <el-tooltip v-if="showMessage" :content="message.text" placement="bottom" effect="danger">
                    <i :class="messageIconClasses" />
                </el-tooltip>
                <i :class="messageIconClasses" v-else />
            </div>
            <!-- END -->
        </template>
...
export default {
    ...
    computed: {
        ...
        showMessage() {
            return !_.isEmpty(this.message.text);
        },
        messageIconClasses() {
