            ...
            <div class="flex-col bg-default round-corner space-between-content register-area">
                ...
                <div class="flex-row">
                    <pt-input size="large"
                        ...
                        :placeholder="_tt('register/placeholder/mobile')"
                        message-mode
                        :message-trigger="createMessageTrigger('mobile')">
                ...
                <div class="flex-row">
                    <pt-input size="large"
                        ...
                        :placeholder="_tt('register/placeholder/verification-code')"
                        message-mode
                        :message-trigger="createMessageTrigger('verificationCode')" />
                </div>
                <div class="flex-row">
                    <pt-input size="large"
                        v-model="model.password"
                        type="password"
                        :placeholder="_tt('register/placeholder/password')"
                        message-mode
                        :message-trigger="createMessageTrigger('password')" />
                </div>
                <div class="flex-row">
                    <pt-input size="large"
                        v-model="model.password2"
                        type="password"
                        :placeholder="_tt('register/placeholder/password2')"
                        message-mode
                        :message-trigger="createMessageTrigger('password2')" />
                </div>
